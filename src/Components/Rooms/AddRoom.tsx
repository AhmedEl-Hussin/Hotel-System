...
export default function AddRoom({getAllRooms, handleClose, setIsLoading, isLoading}) {
  ...
  const AddRoomItem = (data) => {
    ...
    axios.post(`${baseUrl}/admin/rooms`, formData, {
        headers: requstHeaders,
    })
        .then((res) => {
            console.log(res);
    ...
    return (
        ...
        <Typography component='div' sx={{ backgroundColor: 'blue' }}>
            <Typography component='div' sx={{ backgroundColor: 'white', padding: '20px' }}>
                <form noValidate style={{ width: '100%' }} onSubmit={handleSubmit(AddRoomItem)}>
